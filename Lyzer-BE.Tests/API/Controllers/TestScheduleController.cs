...
namespace Lyzer_BE.API.Tests
{
    ...
    public class ScheduleControllerTests
    {
        ...
        [Test]
        public void GetScheduleForYear_ShouldReturnEntireSchedule()
        {
            // Arrange
            ...
            scheduleServiceMock.Setup(s => s.GetFullSchedule("2021"))
                .ReturnsAsync(Events);

            List<RaceWeekendDTO>? result = scheduleController.GetScheduleForYear("2021").Result;
            Assert.That(result, Is.EqualTo(Events));
        }
